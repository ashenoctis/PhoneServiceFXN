...
export class Macbookpage extends Component {
  constructor(props) {
    super(props);
  ...
  axios.post('https://crm.iservice.co.in/website/tag/',{
      "url" :    'https://www.iservice.co.in/Kormangala/Apple/Laptop-Desktop/MacBook/'
      })
    .then(response => {
    ...
    axios.post(apilink+'/website/modelimage/',{
      ...
      issueChecks = response.data.map(result => {
        ...
        var urlredirect = "/Apple/Laptop-Desktop/"+redirecturl+"/";
        return (
              ...
              <Col sm={11} xs={11} lg={12}>
                <div className="newpartners-container">
                  ...
                  <Row>
                    ...
                    <center>
                      MacBook repair services offered at iService <div className="brandnameappen" style={{display: 'inline'}}></div> is popular for the quality of service, service warranty and the affordable prices. iService can do LCD Display Repair, Glass Replacement, Keyboard Repair and Replacement, Touchpad Repair, Speaker Repair, Microphone Repair, Network Repair, Water Damage Repair, Charging Repair, Battery Replacement etc. Searching for the best MacBook repair center near you? Visit us at iService <div className="brandnameappen" style={{display: 'inline'}}></div> or schedule a doorstep service.
                    </center>
                  <br />
                  <br />
                  <br />
