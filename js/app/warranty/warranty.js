    ...
    <div>
      ...
      <MuiThemeProvider>
        ...
        <Container>
            <br />
            <br />
            <center><h1 className="termsheader pageheading"><center>Warranty and Maintenance Contract for Refurbished Products</center></h1></center>
            <center><h3 className="termsheader "><center>Terms & Conditions</center></h3></center>

            <p ><span >This Warranty and Maintenance Contract for Refurbished Products ("<strong>Contract</strong>") has been entered into by and between ServiceMonk Technologies Private Limited (“<strong>ServiceMonk</strong>”) , a company incorporated under the Companies Act,  2013 and having its registered office at 1054 3nd Floor 7th Main 3rd Block Koramangala Bangalore - 560034 and the client mentioned in the physical/digital form duly signed, accepted, and/or viewed by the client (“<strong>Client</strong>”). This Contract shall be fully binding on the Client.</span></p>
            <p ><span >ServiceMonk and the Client are collectively referred to as the <strong>“Parties”</strong> and individually as a <strong>“Party”</strong>.</span></p>
            ...
            <p><span>2.1. ServiceMonk and Client hereby agree to provide and receive respectively, the maintenance services (“<strong>Services</strong>”) as detailed in Annexure 1 herewith to keep the Product(s)/Equipment(s) in proper working condition during the Term.
</span></p>
            <p><span>
            2.2. If required and requested by the Client, ServiceMonk may, at its sole discretion, provide Services not covered within the Scope (“<strong>Additional Services</strong>”) defined in clause 2.1 including without limitation replacement of any spare parts and provision of Services 3.1 listed in below at ServiceMonk's then prevailing rates and terms. The prevailing rates and terms on the Additional Services shall be communicated to the Client at the time ServiceMonk chooses to provide additional services as mentioned in this Clause 2.2.
</span></p>
            <p><span>2.3.  
            All defective spare parts replaced by ServiceMonk with new spare parts or spare parts equivalent to new in performance when replaced shall become property of ServiceMonk and Client shall not claim any right in the same. 
            </span></p>
            ...
            <p><span>3.1.
            A call or job is defined as a visit to the customer to fix a hardware problem which may occur. Maintenance on multiple Devices during the visit may be rectified during the same call. A call length is taken at a maximum of 4 hours longer and it will be termed as 2 calls for every 3 hours henceforth.
</span></p>
            ...
            <p style={{marginLeft:'20px'}}><span>
            3.2.1.6.  which has been damaged due to failure on the part of the Client to follow instructions provided by ServiceMonk for use of Product(s)/Equipment(s) including without limitation provision of standard power connection and dust proof environment; 
            </span></p>

            <p style={{marginLeft:'20px'}}><span>
            3.2.1.7.  which has been relocated by the Client from its original place of installation to a location which is outside the municipal limits of the town/city where service center of ServiceMonk and/or its partners is located;
            </span></p>
         ...
         <p><span>3.3. 
          The Client may choose to avail Services for damaged Product(s)/Equipment(s) specified in clause 3.2 at ServiceMonk's then applicable rates and terms. The prevailing rates and terms for such damaged Product(s)/Equipment(s) shall be communicated to the Client at the time ServiceMonk agrees to provide Services on those damaged Product(s)/Equipment(s).
         </span></p>

          <p><span>3.4.
          To avail Services, Client must present to ServiceMonk, at the time of execution of this Contract, proof of purchase or proof of age of the Product or a declaration for the same in writing in the format approved/acceptable by ServiceMonk.
         </span></p>


          <p><span>3.5.
          ServiceMonk or its authorised representative shall provide Services only during normal working hours on regular working days of ServiceMonk or its authorised representative. 

         </span></p>

          <p><span>3.6. 
          The Client recognises that availability and quality of Services to the Client may be adversely affected by the factors beyond the control of ServiceMonk such as physical obstruction, acts of God, fire, flood, civil commotion, earthquake, war, strikes or government action or change in applicable lawfor which ServiceMonk shall not be held responsible in any manner.

         </span></p>


          <p><span>3.7.
          ServiceMonk makes no express or implied warranties whatsoever regarding the Services provided/rendered and/or effects thereof etc. and shall not be liable to the Client or any other person claiming, by, through or under the Client.
         </span></p>

          <p><span>3.8. 
          ServiceMonk may offer any Service on a complimentary basis to the Client. The complementary Services so offered by ServiceMonk are at any time and without any prior notice liable to be withdrawn and/or offered on payment of charges specified by ServiceMonk.
         </span></p>

          <p><span>3.9.
            Client is aware that ServiceMonk reserves its right to assign any of its rights or obligations to any person and Client undertakes that it shall not object to the same.
         </span></p>

          <p><span>3.10. 
            Based on type of Product(s)/Equipment(s)Equipment, support Services shall be rendered by ServiceMonk personnel either on a Carry-in basis or On-site visit basis. Clarifications on same can be had at the time of purchase of the said Contract or anytime further at helpline/website or any other medium available.
         </span></p>

          <p><span>3.11.
          If damage of the product is in the condition of total loss (as evaluated by brand / ServiceMonk engineer ), then it will not be covered under ServiceMonk maintenance Plan.
         </span></p>

          <p><span>3.12.
            Aesthetic defects, which do not affect the functionality of the product are not covered under ServiceMonk maintenance Plan.
         </span></p>
           ...
           <ol  start="4" className="termsheader">
            ...
            <p  style={{marginLeft:'20px'}}><span>4.1.4. 
            as of the execution of the Contract and throughout Agreement Term, it shall obtain and maintain applicable permits for the receipt of the Services.
            ...
            <p  style={{marginLeft:'20px'}}><span>4.1.6. the information furnished and/or to be furnished by it to the other Party for or in connection with this Contract is and will be true, complete and correct and not misleading in any respect.
              ...
              <p><span>4.2. 
              Client shall provide representative of ServiceMonk/its representative(s) full access to the Product(s)/Equipment(s)/ passwords etc, in order to effect necessary adjustments and/or repairs.
            </span></p>


              <p><span>4.3. 
              Client shall provide adequate storage space for spare parts, test Product(s)/Equipment(s) and adequate work space, heat, light, ventilation and electric current for use by representative of ServiceMonk/its authorized representative for provision of Services at Client's location.
            </span></p>
            ...
            <p  style={{marginLeft:'20px'}}><span>4.4.2.
            upon request of ServiceMonk, support ServiceMonk or its representatives in resolving the problem remotely by starting and executing self tests and/or other diagnostic tools and programs, providing all necessary information or performing basic remedial activities;
            </span></p>


            <p  style={{marginLeft:'20px'}}><span>4.4.3. 
            allow ServiceMonk to keep system and network diagnostic program resident on the Product(s)/Equipment(s) and provide ServiceMonk login access for the exclusive purpose of performing diagnostics;

            </span></p>

            <p  style={{marginLeft:'20px'}}><span>4.4.4.
              be responsible to de-install all add-ons and/or accessories from the Product(s)/Equipment(s) before providing the same to ServiceMonk for Services, maintain backup copy of all software and data, restore software and data on the unit after repair;
            ...
            <p  style={{marginLeft:'20px'}}><span>4.4.7.
            register all complaints/requests for Services only through Service Center/Call Center at telephone numbers or web/app or other medium explicitly provided by ServiceMonk; 
            ...
            <p  style={{marginLeft:'20px'}}><span>4.4.9. 
            indemnify and hold ServiceMonk harmless against any act of omission and commission and any consequences arising thereof and defend ServiceMonk from and against all claims, arising as a result of breach of this Contract;
            </span></p>


            <p  style={{marginLeft:'20px'}}><span>4.4.10. 
            inform ServiceMonk in writing of any change in the billing address. Any written communication from ServiceMonk to Client shallbe deemed as served within 48 hours of posting by ordinary or electronic mail or earlier as the case may be;
            </span></p>

            <p  style={{marginLeft:'20px'}}><span>4.4.11.
              return the standby/loan spare parts, if any provided by ServiceMonk on or before ServiceMonk returning the original set/Spares to the Client;
            </span></p>
              ...
              <p><span>4.6. 
              The Client understands that the Services have been subscribed on his/her own name and name change in any circumstances is not permitted. Client shall not assign any right or interest or delegate any obligation arising herein to any person without ServiceMonk's prior written consent. The Client is solely responsible for any unauthorised transfer/change in ownership of the Product(s)/Equipment(s).
            </span></p>

              <p><span>4.7.
                The Client agrees and understands that in the event of Product(s)/Equipment(s)/Device(s) being beyond economic repairable, which shall be decided solely by ServiceMonk at its sole discretion, ServiceMonk may buy-back the Product(s)/Equipment(s)/ Device(s) at the value calculated from the table mentioned below. It is clarified that ServiceMonk is under no obligation to buy-back the Product(s)/Equipment(s)/ Device(s).
            </span></p>
            <br />
            <br />
            ...
            <center><span>
            *For the purpose of this Clause, “Purchase Value” shall mean the value of the Product(s), Equipment(s), Device(s) at the date of its first purchase from ServiceMonk. For the purpose of clarity, it is clarified that it shall not cover the second hand purchase. An exception, if any, would be at the sole discretion of ServiceMonk.
            </span></center>


              <p><span>4.8.
              Due to any reason, if Client gets replacement directly from brand, it is the responsibility of Client to inform ServiceMonk in writing, about change in product serial number / IMEI number / Model Number. Client is required to write or send email to notify ServiceMonk about this change.
            ...
            <p><span>5.1. Client shall make payment of all charges in advance at the time of subscribing for the Services.
             ...
             <p><span>5.2.
               For Services to be provided by ServiceMonk pursuant to clause 2.1 and repair/replacement of spare parts to be undertaken pursuant to clause 2.2, Client shall forthwith make payments towards cash receipt or invoice raised by ServiceMonk or its authorized representative.
             ...
             <p><span>5.4. 
             If due to any reasons the Product(s)/Equipment(s) is replaced by the original manufacturer with a Product(s)/Equipment(s) of different size/capacity/model/brand but of the same product subcategory, Client shall be responsible to make payment of differential amounts to ServiceMonk for increase in the charges due to change in the Products/Equipment.
            </span></p>

             <p><span>5.5.
             ServiceMonk shall however, not be responsible for refunding any monies to the Client if replacement of the Product(s)/Equipment(s) by the original manufacturer with a Product(s)/Equipment(s) of different size/capacity/model/brand but of the same product subcategory leads to reduction in the charges for Services.
            </span></p>
            ...
            <p><span> Notwithstanding anything contained herein, this Contract may be changed, revised or modified by ServiceMonk at any time before ServiceMonk issues a written confirmation to the Client accepting the Client's application for availing Services.
            ...
            <p><span>7.2. 
            The Client acknowledges that ServiceMonk is the owner and proprietor of all its Intellectual Property including all Intellectual Property in relation to the Services/Additional Services and all the Intellectual Property developed by ServiceMonk in relation to the Services/Additional Services shall also be owned by the Service Provider.
            ...
            <p><span>7.3.
              Save as otherwise provided in Clause 7.2 above, ServiceMonk shall retain all rights title and interest in and to its Intellectual Property and Intellectual Property developed or created by the ServiceMonk or its employees, directors, officers, workmen.

            </span></p>


            <p><span>7.4. 
            The Client hereby acknowledges that ServiceMonk is the absolute owner of the Intellectual Property. This Contract shall not be deemed as any waiver of the Intellectual property of ServiceMonk as regards the Intellectual Property and which shall remain its entire and full Intellectual Property. Consequently, the Client shall not (i) register in any country any intellectual property or, if available under local regulations, designs and/or intellectual property identical, or confusingly similar, to the Intellectual Property; (ii) dispute or contest the validity of the Intellectual Property or the registrations thereof, whether such registrations are now existing or hereafter obtained; or (iii) dispute or contest the exclusive ownership by ServiceMonk in connection with the Intellectual Property.

            </span></p>

            <p><span>7.5.
              The Client shall promptly notify ServiceMonk of any and all infringements, imitations, illegal use or misuse of the Intellectual Property, which come to the client’s attention. Furthermore, the Client undertakes, fully and without any reservation whatsoever, to make promptly and fully available to ServiceMonk, its representatives, agents and attorneys, its assistance in connection with any matter pertaining to the protection of the Intellectual Property whether during or after the term of this Agreement. If legal action of any kind is necessary in order to protect ServiceMonk and the Client’s rights under this Agreement, such legal action may be taken by ServiceMonk under both the ServiceMonk’s and the Client’s names. All the costs of such action shall be borne by the ServiceMonk and ServiceMonk shall benefit from any compensation for damages assessed on the infringing Party.

            </span></p>

            <p><span>7.6. 
            The Client shall take every precaution to prevent the unauthorized use of the Intellectual Property. Upon termination of this Contract or the prior or earlier termination of this Contract, the Client shall immediately cease to use the software and Intellectual Property, or any part thereof, in any manner whatsoever.

            </span></p>

            <p><span>7.7. 
            The Client shall not in any manner, either during the term, or after the termination of this Contract, use in any manner whatsoever, any name, designation, Intellectual Property, trade name, business name or corporate name which phonetically or graphically resembles or evokes the Intellectual Property or its logo or which may otherwise create or maintain confusion in the mind of the public with respect to the Intellectual Property or the Licensor's activities.
            </span></p>
            ...
            <p><span>9.1. This Contract shall be valid during the Agreement Term. Prior to expiry of the Agreement Term, the Parties may mutually renew this Agreement for a successive period as may be mutually agreed thereafter.
             ...
             <p><span>9.2. 
             This Contract may be terminated by ServiceMonk after giving a [30 (thirty) business days] prior written notice to the Client.
            </span></p>


             <p><span>9.3.
              Notwithstanding anything contained herein above, ServiceMonk shall be entitled to terminate or restrict the Services without any notice in any of the following events:
            </span></p>

             <p  style={{marginLeft:'20px'}}><span>9.3.1. 
             If the Client is in breach of the Contract and the Client does not remedy the breach within 3 (three) days of the notification by ServiceMonk
            </span></p>

            <p  style={{marginLeft:'20px'}}><span>9.3.2. If the Client transfers the Product(s)/Equipment(s) to any other person. 
            </span></p>

            <p  style={{marginLeft:'20px'}}><span>9.3.3.
            If the Client relocates the Product(s)/Equipment(s) to a location which is outside the municipal limits of the city /town where the service Center of ServiceMonk is located. 
            ...
            <p  style={{marginLeft:'20px'}}><span>9.3.7. 
            If ServiceMonk at its sole discretion determines that the declaration provided by the Client in accordance with clause 3.3. above is incorrect.
            ...
            <p  style={{marginLeft:'20px'}}><span>9.3.8. The conditions or consequences of Force Majeure continue for such length of time that further performance of the Services would be commercially frustrated.
              The conditions or consequences of Force Majeure continue for such length of time that further performance of the Services would be commercially frustrated.
            </span></p>
             ...
             <p  style={{marginLeft:'20px'}}><span>9.4.1. 
             Simultaneously with the expiration or termination of this Contract, (i) ServiceMonk shall cease to provide all or ay kind of Service(s) under this Contract and (ii) the Client shall forthwith (without any protest or demur) pay all outstanding monies under this Contract to ServiceMonk.
 
            </span></p>

             <p  style={{marginLeft:'20px'}}><span>9.4.2.
              In the event of termination for any reason whatsoever ServiceMonk shall be entitled to recover all outstanding payments due and payable by the Client. ServiceMonk shall, under no circumstances be responsible for refunding any amounts to the Client including without limitation due to termination of the Contract by the Client or due to termination by ServiceMonk.
 
            </span></p>

             <p  style={{marginLeft:'20px'}}><span>9.4.3. 
             The Client agrees and undertakes to immediately delete all the files from their server or record in relation to the Services herein, including but not limited to electronic files, application files and return the documents including but not limited to tangible copies, magnetic or electronic, note(s) and paper(s) or parts thereof, and any copies pertaining to the Services herein (in whatever form(s)). The Client further undertakes to provide a written confirmation for the same to ServiceMonk in a manner acceptable or approved by ServiceMonk. 
 
            </span></p>

             <p  style={{marginLeft:'20px'}}><span>9.4.4. 
              Expiration or earlier termination of this Contract shall not affect the rights or liabilities of the Parties accrued prior to and including the date of termination or expiry.
 
            </span></p>

             <p  style={{marginLeft:'20px'}}><span>9.4.5.
              The following provisions of this Contract shall expressly continue in full force and effect: Charges and Payment, Confidentiality, Consequences of Termination, Non-Solicitation, Arbitration, Governing Law and Jurisdiction.
            </span></p>
            ...
            <p><span>10.3. 
            For the purpose of such arbitration, there shall be three (3) arbitrators (the “Arbitration Board”). The Client shall appoint one arbitrator and ServiceMonk shall be entitled to appoint one arbitrator, and the two appointed arbitrators shall then jointly appoint a third arbitrator, who shall serve as the chairman of the Arbitration Board.
           ...
           <ol  start="11" className="termsheader">
            ...
            <p><span>
            During the term of this Contract, and for a period of one (1) year immediately thereafter, the Client agrees not to solicit any employee or independent contractor or partner of ServiceMonk on behalf of any other business enterprise, nor shall it induce any employee or independent contractor or partner associated with the each other to terminate or breach an employment, contractual or other relationship with the ServiceMonk.
            </span></p>
           ...
           <ol  start="13" className="termsheader">
            ...
            <p><span>
             ServiceMonk shall not be liable to the Client for any damages resulting from or related to any Services performed by ServiceMonk hereunder, including, but not limited to, any loss of data or software, inability of ServiceMonk to correct any errors, malfunctions and defects in the Product(s)/Equipment(s)/hardware/software or delay of ServiceMonk in performing any Services hereunder. It is clarfied that in no event,ServiceMonk shall be liable to the Client for any direct, indirect, special, or consequential damages or lost profits arising out of or related to Services provided by the ServiceMonk under this contract, even if ServiceMonk has been advised of the possibility thereof, or knew or should have known thereof. ServiceMonk's liability hereunder to the Client, if any, shall in no event exceed the total of the charges paid by the Client to ServiceMonk hereunder.
            </span></p>
            ...
            <p><span>14.1. 
            This Contract shall contain the entire understanding of the Parties and shall supersede all prior agreements and understandings, both written and oral, among the Parties with respect to the subject matter hereof.
            </span></p>
            ...
            <p><span>14.6. 
            The Client shall not be entitled to assign or transfer, any of its rights and liabilities under this Contract to any other Party without the prior written consent of ServiceMonk. The Client agrees and understands that ServiceMonk reserves its right to assign any of its rights or obligations to any person/entity and the Client undertakes that it shall not object to the same.
            </span></p>
            ...
            <ol  start="1" className="termsheader">
              <li>
                <h5 >
                ServiceMonk Warranty Plan (SWP)  is the Annual service contract for both Windows and MacBooks. ServiceMonk's offerings under this plan are: 
                </h5>
              </li>
            </ol>
            ...
            <p><span> 1.2.
              One, on client request, diagnosis every 6 months. This includes a diagnosis at the beginning of the contract while giving the device, one after 6 months and one at the conclusion of the contract. 
            </span></p>

            <p><span> 1.3.
              On-demand servicing and diagnosis is also included in this contract. These may be solved remotely as well at the discretion of ServiceMonk.  
            </span></p>


            <p><span> 1.4. 
            Diagnosis and/or servicing may take place either at the premises of the customer or at any of the service centres of ServiceMonk or its partners, associates 
            </span></p>
            ...
            <p><span> 1.7. 
            Upgrades, addition or removal of parts are not included under this plan. 

            </span></p>

            <p><span> 1.8. 
            The customer may have to pay for parts and cost of installation of those parts are included in this plan
            </span></p>
            ...
            <p><span> 1.10. 
            Under fair and reasonable circumstances, ServiceMonk may recommend a change of parts, installation of additional software or writing off of the laptop or a combination of these. 
            </span></p>

            <p><span> 1.11. 
              ServiceMonk may not be held liable for any misinterpretation of diagnosis.
            </span></p>


            <ol  start="2" className="termsheader">
              <li>
                <h5 >ServiceMonk Comprehensive Warranty Plan (SCP)  is the annual maintenance contract. The offerings under this plan are:
            ...
            <ol  start="3" className="termsheader">
              <li>
                <h5 >
                ServiceMonk Protection Plan (SPP) is comprehensive maintenance plan for MacBooks and Laptops including motherboard, 1 instance of physical/liquid/accidental damage. The offerings under this plan are: 
                </h5>
              </li>
            </ol>
            ...
            <p  style={{marginLeft:'20px'}}><span> 3.1.1. Change of parts due to aesthetic issues or wear and tear
