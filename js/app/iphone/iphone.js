              ...
              <Col sm={11} xs={11} lg={12}>
                <div className="newpartners-container">
                  ...
                  <h1 className="new-partner-feature-heading brand brandlist">
                    <center>
                    We Repair & Service the following iPhone Models:
                    </center>
                    <br />
                    <center>
                  ...
                  <Row>
                    ...
                    <center>
                       iPhone repair services at iService <div className="brandnameappen" style={{display: 'inline'}}></div> offers Screen Replacement and Repair at Reasonable Cost. iService can do LCD Display Repair, Glass Replacement, Touchscreen Repair, Speaker Repair, Microphone Repair, Network Repair, Water Damage Repair, Charging Repair, and Battery Replacement and more.  Searching for the best iPhone repair center near you? Visit us at iService <div className="brandnameappen" style={{display: 'inline'}}></div> or schedule a doorstep service. 
                    </center>
                  <br />
                  <br />
                  <br />
