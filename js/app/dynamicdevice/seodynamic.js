...
export class SeoDynamic extends Component {
  ...
  componentDidMount(){
    ...
    axios.get(apilink+'/website/brandimage/').then(response => {
      issueChecks = response.data.map(result => {
        var names=result.split(',')
        var urlredirect =  "/"+location+"/"+names[0]+"/";
        return (
            ...
            <p className="brandname">
              ...
              <center>
                  ...
                  <div className="imagediv card card-5">
                    <img className="logoimage" src={names[1]} width="150" />
                  </div>
                  </NavLink>
                </center>
              </Col>
              ...
              <Col sm={11} xs={11} lg={12}>
                <div className="newpartners-container">
                  <h1 className="new-partner-feature-heading brand brandlist">
                    <center>
                    We Repair & Service the following  brands:
                    </center>
                    <br />
                    <center>
