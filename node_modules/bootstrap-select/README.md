...
- [Download the latest release.](https://github.com/snapappointments/bootstrap-select/archive/v1.13.11.zip)
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.11/dist/js/i18n/defaults-*.min.js"></script>
```
